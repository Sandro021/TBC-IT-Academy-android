...
import com.example.presentation.contract.RegistrationState
        ...
        viewModelScope.launch {
            ...
            getRegistrationFormUseCase().fold(
                ...
                onFailure = {
                    ...
                    _effect.send(RegistrationEffect.ShowSnackbar("Failed to load form"))
                }
            )
        }
    }
    ...
    private fun validateAndSubmit() {
        ...
        if (newErrors.isNotEmpty()) {
            ...
            viewModelScope.launch {
                ...
                _effect.send(RegistrationEffect.ShowSnackbar("Please fix errors"))
            }
        } else {

            viewModelScope.launch {
                _effect.send(RegistrationEffect.ShowSnackbar("Registration Successful"))
            }
        }
    }
}